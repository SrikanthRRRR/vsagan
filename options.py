...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--model', type=str, default='vsagan', help='chooses which model to use. ganomaly')
        ...
        self.parser.add_argument('--abnormal_class', default='anomalies', help='Anomaly class idx for mnist and cifar datasets')
        ...
        self.parser.add_argument('--niter', type=int, default=80, help='number of epochs to train for')
        self.parser.add_argument('--niter_decay', type=int, default=10, help='# of iter to linearly decay learning rate to zero')
        self.parser.add_argument('--beta1', type=float, default=0.55, help='momentum term of adam')
        self.parser.add_argument('--lr', type=float, default=0.00009, help='initial learning rate for adam')
        self.parser.add_argument('--w_adv', type=float, default=20, help='Weight for adversarial loss. default=1')
        ...
        self.parser.add_argument('--w_var', type=float, default=10, help='Weight for latent space loss. default=30')
        self.parser.add_argument('--lr_policy', type=str, default='lambda', help='lambda|step|plateau')
        self.parser.add_argument('--lr_decay_iters', type=int, default=50, help='multiply by a gamma every lr_decay_iters iterations')

        self.parser.add_argument('--g_lat_dim', type=int, default=10, help='Flag to add variation aspect after encoder of generator')
        self.parser.add_argument('--addCBAM', type=int, default=2, help='Flag to add CBAM memory module in encoder and decoder of generator')
        self.parser.add_argument('--CBAMredRatio', type=int, default=3, help='Reduction Ratio for the CBAM channel layers')
        self.parser.add_argument('--CBAMkerSiz', type=int, default=3, help='kernel size for channel attention layer')
        self.parser.add_argument('--stopiternoimp', type=int, default=15, help='Flag to indicate how many epochs to wait if no improvement in AUC and stop training')
        self.parser.add_argument('--vwMdl', type=int, default=0, help='Flag to indicate whether model network need to be viewed in console.')

        self.parser.add_argument('--clnmem', type=int, default=0, help='Flag to indicate whether to clean memory')

        self.parser.add_argument('--DSC', type=int, default=0, help='Flag to indicate whether discrete deperable convolutioning needs to be performed.')
        self.parser.add_argument('--saveBestModelOutput', type=int, default=1, help='Flag to indicate whether the best model among epochs should be used to generate and save images.')
        self.isTrain = True
        self.opt = None
